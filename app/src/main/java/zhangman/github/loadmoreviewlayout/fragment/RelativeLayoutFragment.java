...
public class RelativeLayoutFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    View root = inflater.inflate(R.layout.fragment_relative_layout, container, false);
    ...
    mRelativeLayout = root.findViewById(R.id.relative_layout);
    return root;
  }
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    mPtrClassicFrameLayout.setPtrHandler(new PtrHandler() {
      ...
      public boolean checkCanDoRefresh(PtrFrameLayout frame, View content, View header) {
        return PtrDefaultHandler.checkContentCanBePulledDown(frame, mRelativeLayout, header);
      }
